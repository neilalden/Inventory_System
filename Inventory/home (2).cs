...
namespace Inventory
{
    public partial class home : Form
    {
        ...
        {
            DialogResult res = MessageBox.Show("Purchase "+lblItem.Text+"?","Are you sure?",MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            if (res == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Unable to purchase", "no stocks left", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                }
                else if (result)
                {
                    try
