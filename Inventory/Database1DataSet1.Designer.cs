...
namespace Inventory {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class HistoryDataTable : global::System.Data.TypedTableBase<HistoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public HistoryRow AddHistoryRow(string username, string action, string date) {
            ...
            private void InitClass() {
                ...
                this.columnaction.MaxLength = 60;
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[History] WHERE (([Id] = @Original_Id) AND ([username] = @Origi" +
                "nal_username) AND ([action] = @Original_action) AND ([date] = @Original_date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[History] ([username], [action], [date]) VALUES (@username, @ac" +
                "tion, @date);\r\nSELECT Id, username, action, date FROM History WHERE (Id = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[History] SET [username] = @username, [action] = @action, [date] = @date WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ([action] = @Original_action) AND ([date] = @Original_date));
SELECT Id, username, action, date FROM History WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, action, date FROM dbo.History";
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_action, string Original_date) {
        ...
        public virtual int Insert(string username, string action, string date) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string action, string date, int Original_Id, string Original_username, string Original_action, string Original_date, int Id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string action, string date, int Original_Id, string Original_username, string Original_action, string Original_date) {
            return this.Update(username, action, date, Original_Id, Original_username, Original_action, Original_date, Original_Id);
        }
    }
